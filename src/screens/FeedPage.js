...
const generateCardForItem = (data) => {    
        let feed = data["feed data"].map((feedItem) => {
            ...
            switch (contentType) {
                case 0: return <BlogCard {...feedItem} />
                case 1: return <InternshipCard {...feedItem} />
                case 2: return <ContestCard {...feedItem} />
                case 3: return <TwitterCard {...feedItem} />
            }
        })
        return feed;
}
...
const FeedPage = (props) => {
    ...
    if (data && data["feed data"]) {
        return (<View style={ScreenStyles.screen_basic}>
            ...
            <Text style={TextStyle.subtitle}>Stay updated with your news feed.</Text>
